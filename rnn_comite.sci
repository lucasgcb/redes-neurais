...
erro_comite = calcular_erro_rnn(saidas_comite, dados_esperados_saida)
disp("Erro do comite:" + string(erro_comite))
printar_resultado_rede(saidas_comite_vetor, dados_esperados_saida)
