...
//
PT = [P_;T_];
s = PT(:,41:60) // 1º ARGUMENTO: QUANTIDADE DE AMOSTRAS; 2º ARGUMENTO: MATRIZ PARA AMOSTRAGEM; 3º ARGUMENTO: AMOSTRAGEM POR COLUNA
...
// PARTES DO CÓDIDO FORAM COMENTADAS POIS ERAM RELACIONADAS À FUNÇÃO ann_FFBP_lm
        ...
        mse_min = 1e-; // MSE ALVO PARA PARADA DO TREINAMENTO
